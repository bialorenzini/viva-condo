                ...
                <table className="min-w-full devide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 tracking-winder w-12">Condomínio</th>
                            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 tracking-winder w-12">Unidade</th>
